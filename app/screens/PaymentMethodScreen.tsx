        ...
        <View>
          <SafeAreaView style={paymentMethodStyles.AndroidSafeArea}>
            <View style={paymentMethodStyles.header}>
              <TouchableOpacity style={paymentMethodStyles.backButton} onPress={()=> navigation.goBack()} >
                <Ionicons
                      name="close-outline"
                      size={40}
                      color={Colors.gray1}
            ...
            <TouchableOpacity style={paymentMethodStyles.addButton} onPress={()=> navigation.navigate("AddCardScreen")}>
              <Ionicons 
                name="add-circle"
                color={Colors.orange}
                size={50}

    ...
    <View style={createMyDogsStyles.page}>
      ...
      <ScrollView style={createMyDogsStyles.table}>
        {dogsID.length > 0 ? (
              ...
              <TouchableOpacity onPress={() => toggleExpansion(dog.name)}>
                <View style={createMyDogsStyles.header}>
                  ...
                  <View style={createMyDogsStyles.container}>
                    <Text style={createMyDogsStyles.headerText}>
                      {dog.name}
                    </Text>
                    <Text style={createMyDogsStyles.breedText}>
                      {dog.breed}
                    </Text>
                  </View>
              ...
              {expandedItem === dog.name && (
                <View style={createMyDogsStyles.content}>
                  <View style={createMyDogsStyles.container2}>
                    ...
                    <Text style={createMyDogsStyles.textContent}>
                      {dog.age}
                    </Text>
                  </View>
                  <View style={createMyDogsStyles.container2}>
                    <Text style={createMyDogsStyles.titleContent}>
                      Descripción
                    </Text>
                    <Text style={createMyDogsStyles.textContent}>
                      {dog.description}
                  ...
                  <View style={createMyDogsStyles.buttonContainer}>
                    <View style={createMyDogsStyles.buttonDelete}>
                      ...
                      >
                        <Text style={createMyDogsStyles.buttonDeleteText}>
                          Eliminar
                        </Text>
                      </TouchableOpacity>
                    </View>
                    <View style={createMyDogsStyles.buttonEdit}>
                      ...
                      >
                        <Text style={createMyDogsStyles.buttonEditText}>
                          Editar
                        </Text>
                      </TouchableOpacity>
                    </View>
          ...
          <View>
            <Text style={createMyDogsStyles.textNoDogs}>
              No tienes perros :(
            </Text>
          </View>
        )}
